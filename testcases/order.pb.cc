...
PROTOBUF_CONSTEXPR makeOrderRquest::makeOrderRquest(
...
struct makeOrderRquestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR makeOrderRquestDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~makeOrderRquestDefaultTypeInternal() {}
  union {
    makeOrderRquest _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 makeOrderRquestDefaultTypeInternal _makeOrderRquest_default_instance_;
...
const uint32_t TableStruct_order_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::makeOrderRquest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::makeOrderRquest, _impl_.price_),
  PROTOBUF_FIELD_OFFSET(::makeOrderRquest, _impl_.goods_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::makeOrderRquest)},
  { 8, -1, -1, sizeof(::makeOrderResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::_makeOrderRquest_default_instance_._instance,
...
class makeOrderRquest::_Internal {
 public:
};

makeOrderRquest::makeOrderRquest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:makeOrderRquest)
}
makeOrderRquest::makeOrderRquest(const makeOrderRquest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  makeOrderRquest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:makeOrderRquest)
}

inline void makeOrderRquest::SharedCtor(
...
makeOrderRquest::~makeOrderRquest() {
  // @@protoc_insertion_point(destructor:makeOrderRquest)
...
inline void makeOrderRquest::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.goods_.Destroy();
}

void makeOrderRquest::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void makeOrderRquest::Clear() {
// @@protoc_insertion_point(message_clear_start:makeOrderRquest)
...
const char* makeOrderRquest::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "makeOrderRquest.goods"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* makeOrderRquest::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:makeOrderRquest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:makeOrderRquest)
  return target;
}

size_t makeOrderRquest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:makeOrderRquest)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData makeOrderRquest::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    makeOrderRquest::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*makeOrderRquest::GetClassData() const { return &_class_data_; }


void makeOrderRquest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<makeOrderRquest*>(&to_msg);
  auto& from = static_cast<const makeOrderRquest&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:makeOrderRquest)
...
void makeOrderRquest::CopyFrom(const makeOrderRquest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:makeOrderRquest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool makeOrderRquest::IsInitialized() const {
  return true;
}

void makeOrderRquest::InternalSwap(makeOrderRquest* other) {
  using std::swap;
...
::PROTOBUF_NAMESPACE_ID::Metadata makeOrderRquest::GetMetadata() const {
  ...
  switch(method->index()) {
    case 0:
      makeOrder(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::makeOrderRquest*>(
                 request),
...
const ::PROTOBUF_NAMESPACE_ID::Message& Order::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::makeOrderRquest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
template<> PROTOBUF_NOINLINE ::makeOrderRquest*
Arena::CreateMaybeMessage< ::makeOrderRquest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::makeOrderRquest >(arena);
}
